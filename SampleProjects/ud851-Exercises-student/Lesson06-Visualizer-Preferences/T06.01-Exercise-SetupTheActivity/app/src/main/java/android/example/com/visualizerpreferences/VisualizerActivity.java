...
public class VisualizerActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                Intent myIntent = new Intent(VisualizerActivity.this, SettingsActivity.class);
                VisualizerActivity.this.startActivity(myIntent);
                return true;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.visualizer_menu, menu);//Menu Resource, Menu
        return true;
    }
