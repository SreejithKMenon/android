...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData(){
        locationQuery = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
        new LongOperation().execute(locationQuery);
    }
    ...
    private class LongOperation extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL query = NetworkUtils.buildUrl(params[0]);
            try {
                String response = NetworkUtils.getResponseFromHttpUrl(query);
                String[] result = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, response);
                return result;
